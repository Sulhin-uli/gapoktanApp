...
class SearchFormActivityView extends GetView<ActivityController> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: controller.activityCategoryController.activityCategory
                  .where((e) => e.isActive! == 1)
                  .length,
              itemBuilder: (context, i) {
                final data =
                    controller.activityCategoryController.activityCategory[i];
                if (data.isActive == 1) {
                  return Container(
                    padding: EdgeInsets.all(10),
                    child: ListTile(
                      onTap: () {
                        Get.toNamed(Routes.BY_CATEGORY_ACTIVITY,
                            arguments: data.name);
                      },
